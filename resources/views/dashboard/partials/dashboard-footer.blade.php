...
<script src="{{ asset('public/dashboard/assets/js/jquery-3.1.1.min.js') }}"></script>
<!-- UI Jquery -->
<script src="{{ asset('public/dashboard/assets/js/jquery-ui.js') }}"></script>
<!-- UI Jquery -->
<script src="{{ asset('public/dashboard/assets/js/bootstrap-slider.min.js') }}"></script>
...
<!-- Animation AOS JS -->
<script src="{{ asset('public/dashboard/assets/js/aos.js') }}"></script>
<!-- Animation JS -->
