...
<section class="aboutus">
   <div class="container">
      <div class="row">
         <div class="col-md-8">
            <h3 class="about_us">Privacy Policy</h3>
            <p class="about_content">
               Our Privacy Policy was last updated and posted on December 4, 2017. It governs the
               privacy terms of our Website, located at http://tutorsareus.org, sub-domains, and any
               associated web-based and mobile applications (collectively, &quot;Website&quot;), as owned and
               operated by Tutors Are Us. Any capitalized terms not defined in our Privacy Policy,
               have the meaning as specified in our Terms of Service.
            </p>
            <p class="about_content">
               ...
               Conditions, accessible at http://tutorsareus.org. The following outlines our privacy
               policy.
            </p>
            <p class="about_content">
            ...
            <p class="about_content"> We will only retain personal information as long as necessary for the
               fulfillment of those purposes.
            </p>
            <p class="about_content"> We will collect personal information by lawful and fair means and, where
               appropriate, with the knowledge or consent of the individual concerned.
            </p>
            <p class="about_content"> Personal data should be relevant to the purposes for which it is to be used, and,
               to the extent necessary for those purposes, should be accurate, complete, and
               up-to-date.
            </p>
            <p class="about_content"> We will protect personal information by reasonable security safeguards against
               loss or theft, as well as unauthorized access, disclosure, copying, use or
               modification.
            </p>
            <p class="about_content"> We will make readily available to customers information about our policies and
               practices relating to the management of personal information.
            </p>
            <h3 class="about_us">Your Privacy</h3>
            <p class="about_content">
               Tutors Are Us follows all legal requirements to protect your privacy. Our Privacy
               Policy is a legal statement that explains how we may collect information from you,
               how we may share your information, and how you can limit our sharing of your
               information. We utilize the Personal Data you offer in a way that is consistent with
               this Personal privacy Policy. If you provide Personal Data for a particular reason, we
               could make use of the Personal Data in connection with the reason for which it was
               provided. For example, registration info sent when developing your account, might be
               used to suggest products to you based on past acquisitions. We might use your
               Personal Data to offer access to services on the Website and monitor your use of such
               services. Tutors Are Us may also utilize your Personal Data and various other
               personally non-identifiable info gathered through the Website to assist us with
               improving the material and functionality of the Website, to much better comprehend
               our users, and to improve our services. You will see terms in our Privacy Policy that
               are capitalized. These terms have meanings as described in the Definitions section
               below.
            </p>
            ...
            <p class="about_content">
               ...
               identifiable to you and obtained in order for us to provide you within our Website.
               Personally Identifiable Information may include information such as your name, email
               address, and other related information that you provide to us or that we obtain about
               you.
            </p>
            <h3 class="about_us">Information We Collect</h3>
            <p class="about_content">
            ...
            <h3 class="about_us">Computer Information Collected</h3>
            <p class="about_content">
            ...
            <br> 
            <h3 class="about_us">  Geographical Information </h3>
            <br>
            <p class="about_content">
            ...
            <br> 
            <h3 class="about_us">  Automatic Information </h3>
            <br>
            <p class="about_content">
            ...
            <p class="about_content">
               ...
               divulge more details than is reasonably required. Tutors Are Us abides by this
               demand. Tutors Are Us just collects information willingly offered; no information is
               gathered passively. children under 13 can submit only their email address when
               sending us an email in our &quot;Contact Us&quot; area. Tutors Are Us makes use of the email
               address to respond to a one-time demand from a child under 13 and afterwards deletes
               the email address. In case Tutors Are Us collects and maintains personal information
               relating to a child under 13, the parent may send out an email to us to review, alter
               and/or erase such info as well as to decline to enable any additional collection or use
               of the child&#39;s information.
            </p>
            <h3 class="about_us">How We Use Your Information</h3>
            <p class="about_content">
               We use the information we receive from you as follows:
            </p>
            <p class="about_content">
            <h3 class="about_us">   Customizing Our Website </h3>
            <br>
            <p class="about_content">
            ...
            <br> 
            <h3 class="about_us">  Sharing Information with Affiliates and Other Third Parties </h3>
            <br>
            <p class="about_content">
            ...
            <br> 
            <h3 class="about_us">  Data Aggregation </h3>
            <br>
            <p class="about_content">
            ...
            <br> 
            <h3 class="about_us">  Legally Required Releases of Information</h3>
            <br>
            <p class="about_content">
               ...
               protect the legal rights, personal/real property, or personal safety of Tutors Are
               Us, our Users, employees, and affiliates.
            </p>
            </p>
            <h3 class="about_us">Opt-Out</h3>
            <p class="about_content">
            ...
            <h3 class="about_us">Privacy Policy Updates</h3>
            <p class="about_content">
            ...
            <h3 class="about_us">Questions About Our Privacy Practices or This Privacy Policy</h3>
            <p class="about_content">
